...
!=====================================================================================================================================
      case(4)
        call unstr_explicit(0.07, 2, .false., 10, 0.07*0.01*2, 2,3, 0.001 , 0.001, 3, 2, 3, 2, 3, 0.9, 0., .false., 1, 5)
...
!=====================================================================================================================================
      case(7)
        call semi_explicit(0.7, 2, .false., 10,  0.7*0.1*40, 2, 3, 0.1, 0.1, 3, 2, 3, 2, 3, -0.05, -0.1, .true., 1, 5)
      ...
      case(9)
        ...
        call Semi_implicit_iterative(1., 2, .false., 2, .025*0.005*150, 2, 3, 0.0000125, 0.0000125, 3, 2, 3, 2, 3, 0.,&
         0., .false., 1, 5, 3, 2,4)
